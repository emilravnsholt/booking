...
/***/ "./resources/js/_dynamicFrontend.js":
/*!******************************************!*\
  !*** ./resources/js/_dynamicFrontend.js ***!
  \******************************************/
/***/ (() => {
...
$(function () {
  ...
  $(window).on("scroll", checkScrollTop); // Run on pageload
...
/***/ "./resources/js/_viewHeightFix.js":
/*!****************************************!*\
  !*** ./resources/js/_viewHeightFix.js ***!
  \****************************************/
/***/ (() => {
...
__webpack_require__(/*! ./_bootstrap */ "./resources/js/_bootstrap.js");

__webpack_require__(/*! ./_viewHeightFix */ "./resources/js/_viewHeightFix.js");

__webpack_require__(/*! ./_dynamicFrontend */ "./resources/js/_dynamicFrontend.js");
    ...
    $.ajax({
      ...
      success: function success(result) {
        ...
        if (result.errors) {
          ...
          $("#booking_form button[type='submit']").text(result.success).attr("disabled", true);
        }
      }
    });
  });
